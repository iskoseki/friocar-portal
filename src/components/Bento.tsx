        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <p className="leading-relaxed text-base">
              Somos una empresa de Rosario fundada en 2004, dedicada al servicio
              del automotor en distintas especialidades, para satisfacer las
              necesidades de nuestros clientes. Tenemos como meta lograr rapidez
              y calidad en cada uno de nuestros trabajos. Para eso contamos con
              personal especializado y la tecnología necesaria para todo tipo de
              vehículos.
            </p>
            <p className="mt-3">
              En{" "}
              ...
              herramientas y las normas de seguridad correspondientes utilizando
              siempre productos de primera calidad y respetando el medio
              ambiente.
            </p>
            <button
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <ul className="list-inside  my-4">
              <li className="leading-relaxed text-base">
                Reparacióne instalación de Aire acondicionado y Calefacción para
                vehículos.
              </li>
              <li className="leading-relaxed text-base">
        ...
        <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <ul>
              ...
              <li>Nuestros horarios son: De Lunes a Viernes de 8:30 a 17hs.</li>
            </ul>
            <Link
              to={`/contacto`}
              className="mt-3 text-red-500 inline-flex items-center"
